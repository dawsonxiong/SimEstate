/**
 * This class represents an Apartment, a subclass of ResidentialBuilding.
 * An apartment is a type of residential building containing individual housing units
 */
public class Apartment extends ResidentialBuilding {
    ...
    public static double calculateApartmentPrice(double surfaceArea, int numBathrooms, int numBedrooms) {
        ...
        return basePrice + bathroomFees + bedroomFees;
    }
}
