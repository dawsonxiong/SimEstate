...
public class SimEstate extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        backDropModes.setIcon(new javax.swing.ImageIcon(getClass().getResource("resources/Sim Modes.png"))); // NOI18N
        ...
        btnCDes.setIcon(new javax.swing.ImageIcon(getClass().getResource("resources/Confirm.png"))); // NOI18N
        ...
        backdropCDes.setIcon(new javax.swing.ImageIcon(getClass().getResource("resources/Contract Destination.png"))); // NOI18N
        ...
        lblConfig.setIcon(new javax.swing.ImageIcon(getClass().getResource("resources/houseConfig.png"))); // NOI18N
        jPanel3.add(lblConfig);
        lblConfig.setBounds(450, 200, 250, 200);

        btnCBuild.setIcon(new javax.swing.ImageIcon(getClass().getResource("resources/Confirm.png"))); // NOI18N
        ...
        backdropCBuild.setIcon(new javax.swing.ImageIcon(getClass().getResource("resources/Contract-Build.png"))); // NOI18N
        ...
        btnGDes.setIcon(new javax.swing.ImageIcon(getClass().getResource("resources/Confirm.png"))); // NOI18N
        ...
        backdropGDes.setIcon(new javax.swing.ImageIcon(getClass().getResource("resources/Gov Destination.png"))); // NOI18N
        ...
        btnGBuild.setIcon(new javax.swing.ImageIcon(getClass().getResource("resources/Confirm.png"))); // NOI18N
        ...
        backdropGBuild.setIcon(new javax.swing.ImageIcon(getClass().getResource("resources/Gov Build.png"))); // NOI18N
        ...
        lblBonus.setIcon(new javax.swing.ImageIcon(getClass().getResource("resources/proxBonus.png"))); // NOI18N
        jPanel7.add(lblBonus);
        lblBonus.setBounds(360, 220, 220, 25);

        btnProximity.setIcon(new javax.swing.ImageIcon(getClass().getResource("resources/info.png"))); // NOI18N
        ...
        backdropBuy.setIcon(new javax.swing.ImageIcon(getClass().getResource("resources/Buy House.png"))); // NOI18N
        ...
        backdropNearest.setIcon(new javax.swing.ImageIcon(getClass().getResource("resources/Nearest.png"))); // NOI18N
        ...
        btnBegin.setIcon(new javax.swing.ImageIcon(getClass().getResource("resources/Begin.png"))); // NOI18N
        ...
        backDrop.setIcon(new javax.swing.ImageIcon(getClass().getResource("resources/Sim Estate.png"))); // NOI18N
    ...
    private void cmbCBuildTypeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbCBuildTypeActionPerformed
        ...
        if(cmbCBuildType.getSelectedItem().equals("House")) {
            lblConfig.setIcon(new javax.swing.ImageIcon(getClass().getResource("resources/houseConfig.png")));
            ...
            lblConfig.setIcon(new javax.swing.ImageIcon(getClass().getResource("resources/apartmentConfig.png")));
        }
    ...
    private void buyListValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_buyListValueChanged
        if (!evt.getValueIsAdjusting() && buyList.getSelectedIndex() != -1) { // only run on the mouse click release event
            ...
            lblBonus.setIcon(openHouse.isBonus() == true ? new javax.swing.ImageIcon(getClass().getResource("resources/proxBonus.png")) : new javax.swing.ImageIcon(getClass().getResource("/proxPenalty.png")));
            
            // Check the type of the selected ResidentialBuilding and customize the UI accordingly
            if(openHouse.getId().contains("HH")) {
                backdropBuy.setIcon(new javax.swing.ImageIcon(getClass().getResource("resources/Buy House.png")));
                ...
                backdropBuy.setIcon(new javax.swing.ImageIcon(getClass().getResource("resources/Buy Townhouse.png")));
                lblYard.setText(String.valueOf(((Townhouse) openHouse).getBackyardSize()) + " sqft");
                lblParking.setText(String.valueOf(openHouse.getParkingSpaces()));
            } else {
                backdropBuy.setIcon(new javax.swing.ImageIcon(getClass().getResource("resources/Buy Apartment.png")));
